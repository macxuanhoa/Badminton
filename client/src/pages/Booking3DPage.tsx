    ...
    <div className="relative isolate w-full h-screen overflow-hidden bg-[#020617]">
      ...
      <div className="absolute top-4 md:top-6 left-4 md:left-6 right-4 md:right-6 z-[450] pointer-events-auto">
        <div className="flex flex-col md:grid md:grid-cols-3 items-center gap-3 md:gap-4">
          ...
          <div className="flex w-full md:w-full justify-center items-center gap-3 md:gap-4 pb-1 md:pb-0 min-w-0">
            <div className="bg-[#020617] px-3 md:px-4 xl:px-5 py-2 md:py-3 rounded-2xl border border-white/5 flex items-center gap-2 md:gap-4 backdrop-blur-md shadow-2xl min-w-0">
              <div className="flex items-center gap-2 md:gap-4 px-2 py-1 min-w-0">
                {['Khám phá', 'Chọn sân', 'Chọn giờ', 'Xác nhận'].map((label, i) => (
                  <div key={label} className="flex items-center gap-1.5 md:gap-2 shrink-0">
                    ...
                    <span className={`text-[9px] md:text-[10px] font-bold uppercase tracking-widest hidden 2xl:inline ${i === stepIndex ? 'text-white' : 'text-gray-600'}`}>
                      {label}
                    </span>
            ...
            <input 
              ...
              className="custom-date-input bg-[#020617] border border-white/10 text-white rounded-2xl px-3 md:px-4 xl:px-5 py-2 md:py-3 text-[10px] md:text-[11px] font-bold focus:outline-none focus:border-primary/50 shadow-2xl backdrop-blur-md shrink-0"
